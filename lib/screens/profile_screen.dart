...
import 'package:instagram_clone_flutter/screens/screen.dart';
            ...
            child: Column(
              children: [
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              buildStatColumn(following, 'seguidos')
                            ],
                          ),
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                ...
                Container(
                  ...
                  child: Text(
                      userData['username'], style: const TextStyle(
  ...
  Column buildStatColumn(int num, String label){
    return Column(
      ...
      children: [
        ...
        Container(margin: const EdgeInsets.only(top:4), child: Text(label, style: const TextStyle(fontSize: 15, fontWeight: FontWeight.w400, color: Colors.grey)))
      ],
    );
  }
}